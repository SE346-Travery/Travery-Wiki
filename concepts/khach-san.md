...
- **Occupancy**: Each room type has a maximum capacity. Extra guests incur fees or require additional rooms.
- **No Show-up Policy**:
    - Room is held until 23:59 on the arrival date.
    - If the guest doesn't arrive or contact staff by 23:59, the room is released.
    - **No refund** is provided for no-shows.
- **Cancellation & Refund Policy**:
    - >72 hours before check-in: 100% refund.
    - 24-72 hours before check-in: 50% refund.
