...
- **Minimum Occupancy**: Tours only depart with at least 10 people. If not met 3 days before departure, Travery may reschedule or refund 100%.
- **List Finalization**: Guest list must be finalized 5 days before departure.
- **No Show-up Policy**: 
    - Guide waits for 15 minutes at the pickup point.
    - If unreachable, the tour departs without the guest.
    - **No refund** is provided for no-shows.
- **Cancellation & Refund Policy**:
    - >7 days before departure: 100% refund.
    - 3-6 days before departure: 50% refund.
    - <3 days before departure: 0% refund.
